...
import nepjr.tech.api.unification.material.NTMaterialFlags;
...
public final class GeneratedFluidHandler {
    ...
    public static void createMoltenFluid(@NotNull Material material) {
        ...
        if (material.hasFlag(NTMaterialFlags.DISABLE_ALLOY_PROPERTY)) return;
        ...
        AlloyBlastProperty alloyBlastProperty = material.getProperty(NTPropertyKey.ALLOY_BLAST);
        ...
        if (alloyBlastProperty.shouldGenerateMolten(material)) {
            fluidProperty.enqueueRegistration(NTFluidStorageKeys.MOLTEN, new FluidBuilder()
