...
public final class AlloyBlastPropertyAddition {
    ...
    public static void init() {
        for (Material material : GregTechAPI.materialManager.getRegisteredMaterials()) {
            if (!material.hasFlag(NTMaterialFlags.DISABLE_ALLOY_PROPERTY)) {
    ...
    private static void addAlloyBlastProperty(@NotNull Material material) {
        ...
        material.setProperty(NTPropertyKey.ALLOY_BLAST, new AlloyBlastProperty(material.getBlastTemperature()));
    }
