package nepjr.tech.api.recipes.alloyblast;
...
import nepjr.tech.api.fluids.NTFluidStorageKeys;
...
public class AlloyBlastRecipeProducer {
    ...
    public void produce(@NotNull Material material, @NotNull BlastProperty blastProperty) {
        ...
        if (material.hasFlag(NTMaterialFlags.NO_ALLOY_BLAST_RECIPES)) return;
        ...
        Fluid output = material.getFluid(NTFluidStorageKeys.MOLTEN);
        if (output == null) {
