...
public class WorldGenLargeRubberTree extends WorldGenAbstractTree 
{
    private static final IBlockState RUBBER_LOG = MetaBlocks.RUBBER_LOG.getDefaultState().withProperty(BlockRubberLog.NATURAL, true);
    private static final IBlockState RUBBER_LEAVES = MetaBlocks.RUBBER_LEAVES.getDefaultState();

    public WorldGenLargeRubberTree(boolean notify)
    {
        super(notify);
    }
    ...
    private void placeLogAt(World worldIn, BlockPos pos)
    {
        ...
        {
            this.setBlockAndNotifyAdequately(worldIn, pos, RUBBER_LOG);
        }
    }
    ...
    private void placeLeafAt(World worldIn, int x, int y, int z)
    {
        ...
        {
            this.setBlockAndNotifyAdequately(worldIn, blockpos, RUBBER_LEAVES);
        }
    }
