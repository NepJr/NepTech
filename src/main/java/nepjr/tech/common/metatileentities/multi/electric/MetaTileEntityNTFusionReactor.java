...
public class MetaTileEntityNTFusionReactor extends RecipeMapMultiblockController
    ...
    private final MetaTileEntityNTFusionReactor.FusionProgressSupplier progressBarSupplier;

    @SideOnly(Side.CLIENT)
    private boolean registeredBloomRenderTicket;

    public MetaTileEntityNTFusionReactor(ResourceLocation metaTileEntityId, int tier) {
        super(metaTileEntityId, RecipeMaps.FUSION_RECIPES);
        this.recipeMapWorkable = new MetaTileEntityNTFusionReactor.FusionRecipeLogic(this);
        this.tier = tier;
        ...
        this.progressBarSupplier = new MetaTileEntityNTFusionReactor.FusionProgressSupplier();
    }

    @Override
    public MetaTileEntity createMetaTileEntity(IGregTechTileEntity tileEntity) {
        return new MetaTileEntityNTFusionReactor(metaTileEntityId, tier);
    }
    ...
    public List<MultiblockShapeInfo> getMatchingShapes() {
        ...
        MultiblockShapeInfo.Builder baseBuilder = MultiblockShapeInfo.builder()
                ...
                .aisle("######DCD######", "####GG###GG####", "######UCU######")
                .aisle("###############", "######EME######", "###############")
                .where('M', NTMetaTileEntities.NT_FUSION_REACTOR[tier - GTValues.UHV], EnumFacing.SOUTH)
                .where('C', getCasingState())
                .where('G', MetaBlocks.TRANSPARENT_CASING.getState(
                        BlockGlassCasing.CasingType.FUSION_GLASS))
                .where('K', getCoilState())
                .where('W', MetaTileEntities.FLUID_EXPORT_HATCH[GTValues.UHV], EnumFacing.NORTH)
                .where('E', MetaTileEntities.FLUID_EXPORT_HATCH[GTValues.UHV], EnumFacing.SOUTH)
                .where('S', MetaTileEntities.FLUID_EXPORT_HATCH[GTValues.UHV], EnumFacing.EAST)
                .where('N', MetaTileEntities.FLUID_EXPORT_HATCH[GTValues.UHV], EnumFacing.WEST)
                ...
                .where('U', MetaTileEntities.FLUID_IMPORT_HATCH[GTValues.UHV], EnumFacing.UP)
                .where('D', MetaTileEntities.FLUID_IMPORT_HATCH[GTValues.UHV], EnumFacing.DOWN)
    ...
    private IBlockState getCasingState() {
        if (tier == GTValues.UHV)
            return NTMetaBlocks.NT_FUSION_CASING.getState(BlockNTFusionCasings.NTFusionCasingType.MK4);
        if (tier == GTValues.UEV)
            return NTMetaBlocks.NT_FUSION_CASING.getState(BlockNTFusionCasings.NTFusionCasingType.MK5);

        return NTMetaBlocks.NT_FUSION_CASING.getState(BlockNTFusionCasings.NTFusionCasingType.MK6);
    }
    ...
    protected ModularUI.Builder createUITemplate(EntityPlayer entityPlayer) {
        ...
        builder.widget(MetaTileEntityNTFusionReactor.FusionProgressSupplier.Type.BOTTOM_LEFT.getWidget(this));
        builder.widget(MetaTileEntityNTFusionReactor.FusionProgressSupplier.Type.TOP_LEFT.getWidget(this));
        builder.widget(MetaTileEntityNTFusionReactor.FusionProgressSupplier.Type.TOP_RIGHT.getWidget(this));
        builder.widget(MetaTileEntityNTFusionReactor.FusionProgressSupplier.Type.BOTTOM_RIGHT.getWidget(this));
    ...
    private static class FusionProgressSupplier {
        ...
        public DoubleSupplier getSupplier(MetaTileEntityNTFusionReactor.FusionProgressSupplier.Type type) {
            return switch (type) {
        ...
        private enum Type {
            ...
            public ProgressWidget getWidget(MetaTileEntityNTFusionReactor instance) {
    ...
    private class FusionRecipeLogic extends MultiblockRecipeLogic {
        ...
        public FusionRecipeLogic(MetaTileEntityNTFusionReactor tileEntity) {
            super(tileEntity);
        }
        ...
        protected void modifyOverclockPre(int @NotNull [] values, @NotNull IRecipePropertyStorage storage) {
            ...
            if (fusionTier != 0) fusionTier = MetaTileEntityNTFusionReactor.this.tier - fusionTier;
        ...
        protected void setActive(boolean active) {
            if (active != isActive) {
                MetaTileEntityNTFusionReactor.this.progressBarSupplier.resetCountdown();
            }
    ...
    public void renderMetaTileEntity(double x, double y, double z, float partialTicks) {
        if (this.hasFusionRingColor() && !this.registeredBloomRenderTicket) {
            ...
            BloomEffectUtil.registerBloomRender(MetaTileEntityNTFusionReactor.FusionBloomSetup.INSTANCE, getBloomType(), this, this);
        }
    }
    ...
    private static final class FusionBloomSetup implements IRenderSetup {
        ...
        private static final MetaTileEntityNTFusionReactor.FusionBloomSetup INSTANCE = new MetaTileEntityNTFusionReactor.FusionBloomSetup();
