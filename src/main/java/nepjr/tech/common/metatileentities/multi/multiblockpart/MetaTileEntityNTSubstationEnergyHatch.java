package nepjr.tech.common.metatileentities.multi.multiblockpart;
...
public class MetaTileEntityNTSubstationEnergyHatch extends MetaTileEntityNTEnergyHatch 
{

    public MetaTileEntityNTSubstationEnergyHatch(ResourceLocation metaTileEntityId, int tier, int amperage, boolean isExportHatch) 
    {
    ...
    {
        return new MetaTileEntityNTSubstationEnergyHatch(metaTileEntityId, getTier(), amperage, isExportHatch);
    }
