...
public class MetaTileEntitySterileMaintenanceHatch extends MetaTileEntityAutoMaintenanceHatch {
    ...
    public MetaTileEntitySterileMaintenanceHatch(ResourceLocation metaTileEntityId) {
        super(metaTileEntityId);
    }

    @Override
    public MetaTileEntity createMetaTileEntity(IGregTechTileEntity tileEntity) {
        return new MetaTileEntitySterileMaintenanceHatch(metaTileEntityId);
    }
