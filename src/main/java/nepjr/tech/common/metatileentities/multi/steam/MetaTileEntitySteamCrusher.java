package nepjr.tech.common.metatileentities.multi.steam;
...
public class MetaTileEntitySteamCrusher extends RecipeMapSteamMultiblockController {

	protected final int level;
	protected final int PARALLEL_LIMIT;

    public MetaTileEntitySteamCrusher(int level, ResourceLocation metaTileEntityId) {
    ...
    public MetaTileEntity createMetaTileEntity(IGregTechTileEntity metaTileEntityHolder) {
        return new MetaTileEntitySteamCrusher(level, metaTileEntityId);
    }
